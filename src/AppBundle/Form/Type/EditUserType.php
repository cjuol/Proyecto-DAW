    ...
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        ...
        if ('Admin' == $usuario->getRol()) {
            ...
            $builder
                ->add('prioridad', IntegerType::class, array('label' => 'Prioridad: ', 'attr' => (array('class' => 'form-control', 'placeholder' => 'Introduzca prioridad'))))
                ->add('rol',
                    EntityType::class, array('class'=> Rol::class, 'label' => 'Rol: ', 'attr' => (array('class' => 'form-control')),
                        'query_builder' => function (EntityRepository $er) {
                ...
                ->add('departamento',
                    EntityType::class, array('class' => Departamento::class ,'label' => 'Departamento: ', 'attr' => (array('class' => 'form-control')),
